  ...
  const content = (
    <div>
      <p>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://amzn.to/2UfIfAx"> Mamas & Papas Acro </a> and <a target="_blank" rel="noopener noreferrer" href="https://amzn.to/2Okvq4h"> Micralite ProFold </a>
      ...
      <p>
        The <a target="_blank" rel="noopener noreferrer" href="https://amzn.to/2RR0xGR"> BabyBjörn </a> travel cot has to be one of the best designed, for it's simplicity to setup and
        ...
        to setup of any i've used! The <a target="_blank" rel="noopener noreferrer" href="https://amzn.to/36MdDJD"> Micralite </a> is a similar design, although it's packed size is a little
      ...
      <p>
        ...
        <a target="_blank" rel="noopener noreferrer" href="https://amzn.to/2OjNoUj"> BabyBjörn Baby Carrier One Air</a> is another fantastic product from BabyBjörn that is simple
        and comfortable to use. As your little one outgrows it's first carrier, the <a target="_blank" rel="noopener noreferrer" href="https://amzn.to/2OgWp0k"> LittleLife Ranger S2 </a> is a
      ...
      <p>
        ...
        comfortably and safely enjoy meal time.  For the younger ones, the <a target="_blank" rel="noopener noreferrer" href="https://amzn.to/36K9fux"> Phil and Teds Lobster </a> is perfect.
        For those a little bigger, the <a target="_blank" rel="noopener noreferrer" href="https://amzn.to/2GW3Qq1"> Munchkin Booster Seat </a> is super versatile and will get years of use.
      </p>
      <Products
        products={[
