...
export default function ListIdeasPage(props) {
  const recentArticles = [
    {title: "The Essentials Baby List", url: "/listideas/babyessentials", img: 'https://test.ewelists.com/images/baby-essentials.jpg', img_position_left: false,
    ...
    {title: "Travel Gear", url: "/listideas/travelgear", img: 'https://test.ewelists.com/images/travel-gear.jpg', img_position_left: true,
    ...
    {title: "Nursery List", url: "/listideas/nursery", img: 'https://test.ewelists.com/images/nursery-list.jpg', img_position_left: true,
    ...
    {title: "Bath Time", url: "/listideas/bathtime", img: 'https://test.ewelists.com/images/bath-time.jpg', img_position_left: false,
    ...
    {title: "Christmas Ideas", url: "/listideas/christmasfortoddlers", img: 'https://test.ewelists.com/images/christmas-toddlers.jpg', img_position_left: true,
